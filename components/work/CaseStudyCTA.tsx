        ...
        <div className="relative overflow-hidden rounded-3xl border border-border bg-surface px-6 py-20 sm:px-12 sm:py-24 md:px-16 md:py-28">
          ...
          <div className="relative mx-auto max-w-3xl text-center">
            ...
            >
              ...
              <span className="text-accent-secondary">brand project?</span>
            </motion.h2>
            ...
            >
              Whether you&apos;re launching, repositioning, or scaling — we&apos;d
              love to hear what you&apos;re building and see if we&apos;re the
              right studio to help.
            </motion.p>
