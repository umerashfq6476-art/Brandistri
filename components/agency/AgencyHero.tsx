    ...
    <section className="relative isolate overflow-hidden bg-background">
      ...
      <div className="container-x relative flex min-h-[calc(100vh-72px)] flex-col justify-center pt-24 pb-24 md:pt-28 md:pb-32">
        ...
        <h1 className="mt-8 max-w-5xl font-display text-6xl sm:text-7xl md:text-8xl lg:text-[112px] font-semibold leading-[0.96] tracking-[-0.025em] text-text-primary">
          {words.map((word, i) => (
            <span key={word} className="inline-block overflow-hidden align-bottom mr-[0.18em]">
              <motion.span
                ...
                className={`inline-block ${
                  word === "Brandistri" ? "text-accent-secondary" : ""
                }`}
              >
                {word}
              </motion.span>
        ...
        >
          A strategic branding studio built for businesses that want to stand
          out, communicate clearly, and grow with purpose.
        </motion.p>
      </div>
    </section>
  );
