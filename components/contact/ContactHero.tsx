...
const words = ["Let's", "Build", "Something", "Powerful", "Together"];
  ...
  return (
    <section className="relative isolate overflow-hidden bg-background">
      ...
      <div className="container-x relative flex min-h-[calc(100vh-72px)] flex-col justify-center pt-24 pb-24 md:pt-28 md:pb-32">
        ...
        <h1 className="mt-8 max-w-5xl font-display text-5xl sm:text-6xl md:text-7xl lg:text-[96px] font-semibold leading-[0.98] tracking-[-0.025em] text-text-primary">
          {words.map((word, i) => (
            <span
              key={word}
            ...
            >
              <motion.span
                ...
                className={`inline-block ${
                  word === "Powerful" ? "text-accent-secondary" : ""
                }`}
              >
                {word}
              </motion.span>
